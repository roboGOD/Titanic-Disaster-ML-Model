...
######################## LogisticRegression ###############################
### Finding best value for C as .045
# samp_vals = [x*0.001 for x in range(1,100)]
# accuracies = []
# for i in samp_vals:
...
### Finding best value for solver as lbfgs
# samp_vals = ['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga']
# accuracies = []
# for i in samp_vals:
# 	clf = LogisticRegression(C=0.045, solver=i, random_state=42)
# 	clf.fit(X_train, y_train)
# 	accuracies.append(clf.score(X_val, y_val))

# plt.bar(samp_vals, accuracies)
# plt.xlabel('solver')
# plt.ylabel('Accuracy')
# plt.show()

### Finding best value for multi_class as ovr
# samp_vals = ['ovr', 'multinomial']
# accuracies = []
# for i in samp_vals:
# 	clf = LogisticRegression(C=0.045, solver='lbfgs', multi_class=i, random_state=42)
# 	clf.fit(X_train, y_train)
# 	accuracies.append(clf.score(X_val, y_val))
